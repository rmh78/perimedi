...
Walk this map top to bottom for a broad regression. Order is Cycle, Month, Trends, More, medication sheet, period sheet, symptom sheet, dose reminders, doctor visit, backup, then the first-use journey. Driving one convenient entry point is not a sweep.
