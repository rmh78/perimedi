...
- **WHEN** the active language is German and a next-dose Home Screen widget is shown
- **THEN** widget chrome is German and the medication name and dose label stay as typed
