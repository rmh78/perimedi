...
- **WHEN** the active language is German and the next-dose Home Screen widget is shown
- **THEN** widget titles and the Taken action are in German and the medication name stays as typed
