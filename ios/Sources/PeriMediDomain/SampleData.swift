...
public enum SampleData {
    public static func payload(now: Date = Date()) -> ExportPayload {
        ...
        let symptomScores: [SymptomScore] = [
            ...
            score(.mood, daysAgo: 38, severity: 2),
            score(.mood, daysAgo: 30, severity: 3),
            score(.vaginal_dryness, daysAgo: 36, severity: 2),
            score(.vaginal_dryness, daysAgo: 27, severity: 3),
            // Cycle that started 74 days ago.
            score(.hot_flash, daysAgo: 74, severity: 3),
            score(.hot_flash, daysAgo: 70, severity: 3),
            score(.hot_flash, daysAgo: 66, severity: 2),
            score(.hot_flash, daysAgo: 55, severity: 3),
            score(.sleep, daysAgo: 73, severity: 2),
            score(.sleep, daysAgo: 68, severity: 2),
            score(.sleep, daysAgo: 61, severity: 3),
            score(.mood, daysAgo: 72, severity: 2),
            score(.mood, daysAgo: 52, severity: 2),
            score(.vaginal_dryness, daysAgo: 69, severity: 2),
            score(.vaginal_dryness, daysAgo: 48, severity: 2),
            // Oldest logged cycle (103 days ago).
            score(.hot_flash, daysAgo: 103, severity: 2),
            score(.hot_flash, daysAgo: 97, severity: 2),
            score(.hot_flash, daysAgo: 90, severity: 3),
            score(.hot_flash, daysAgo: 86, severity: 2),
            score(.sleep, daysAgo: 102, severity: 2),
            score(.sleep, daysAgo: 95, severity: 1),
            score(.sleep, daysAgo: 88, severity: 2),
            score(.mood, daysAgo: 101, severity: 1),
            score(.mood, daysAgo: 92, severity: 2),
            score(.vaginal_dryness, daysAgo: 99, severity: 1),
            score(.vaginal_dryness, daysAgo: 87, severity: 2),
        ]
