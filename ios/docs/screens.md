...
CI fails only if an expected file is **missing**. Pixel drift does not fail the suite. After a layout change, run `.grok/skills/verify-perimedi/scripts/control-perimedi verify` and commit any updated PNGs.
